...
export const QUEST_DEFINITIONS: readonly QuestDefinition[] = [
  ...
  },
  {
    ...
    title: "조선후기의 서민문화",
    summary: "아론과 카프와 함께 던전 6층의 서민 문화를 조사하자.",
    description: "외부인이라는 사실을 숨기며 조선 후기 서민 문화가 펼쳐진 던전 6층을 통과한다.",
    objectiveText: "던전 6층 마지막 방 조사",
    giverNpcId: "kaiden",
    turnInNpcId: "jeon",
    ...
    rewards: { description: "10 Gold · 김홍도의 붓(희귀)" },
  },
  {
    id: "quest-floor-7-goryeo-founding",
    title: "개항 전후의 조선(1)",
    summary: "아론과 함께 던전 7층으로 들어가 데네브를 구출하자.",
    description: "개항 전후 혼란에 뒤틀린 던전 7층을 통과하여 데네브를 구출한다.",
    objectiveText: "던전 7층에서 데네브 구출",
    giverNpcId: "kaiden",
    turnInNpcId: "denebCommander",
    offerStorySequenceId: "npc-aron-floor-7-quest-available",
    acceptStorySequenceId: "npc-aron-floor-7-quest-accepted",
    activeStorySequenceId: "npc-aron-floor-7-quest-active",
    targetFloorId: "floor-7",
    completeStorySequenceId: "npc-deneb-floor-7-quest-complete",
    rewards: { description: "20 Gold · 척화비(희귀)" },
  },
  {
