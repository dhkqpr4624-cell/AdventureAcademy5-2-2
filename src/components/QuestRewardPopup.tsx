...
export function QuestRewardPopup({
  ...
  const displayRareReward = showRareReward && (rareUnlocked || showLockedRareReward);
  ...
  return (
    <div className="pixel-popup-backdrop">
      <section className="pixel-rpg-popup quest-reward-popup" role="dialog" aria-modal="true" aria-labelledby="quest-reward-title">
        ...
        <div className={`quest-reward-grid ${displayRareReward ? "" : "is-base-only"}`}>
          ...
          {displayRareReward && <article className={rareUnlocked ? "is-unlocked" : "is-locked"}>
